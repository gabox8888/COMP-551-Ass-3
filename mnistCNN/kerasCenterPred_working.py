...
#print(train_x[3])
# Load autoencoder
#transformer = load_model('mnist_autoencoder_wshifting.h5')
...
def getPredictions(tx,cs):
	...
	with warnings.catch_warnings():
		...
		for i,img in enumerate(tx):
			...
			# Run subimage through autoencoder
	#		digit1 = transformer.predict( digit1 )#.reshape((1,28,28,1))
	#		digit2 = transformer.predict( digit2 )#.reshape((1,28,28,1))
